...
export function loadConfig(startDir = process.cwd(), explicitConfigPath) {
...
function mergeWithDefaults(userConfig, loadedFrom) {
    return {
        ...DEFAULT_CONFIG,
        ...userConfig,
...
export function isCommandAllowed(fullCommand, config) {
